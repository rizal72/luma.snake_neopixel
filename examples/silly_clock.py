...
def minute_change(device):
    ...
    def helper(current_y):
        with canvas(device) as draw:
            ...
            text(draw, (7, 1), ":", fill="white", font=proportional(TINY_FONT))
            text(draw, (8, current_y), minutes, fill="white", font=proportional(TINY_FONT))
        time.sleep(0.1)
...
def animation(device, from_y, to_y):
    ...
    while current_y != to_y:
        with canvas(device) as draw:
            ...
            text(draw, (7, current_y), ":", fill="white", font=proportional(TINY_FONT))
            text(draw, (8, current_y), mintime, fill="white", font=proportional(TINY_FONT))
        time.sleep(0.1)
    ...
    while True:
        ...
        if sec == 59:
            ...
            with canvas(device) as draw:
                ...
                text(draw, (8, 1), minutes, fill="white", font=proportional(TINY_FONT))
            time.sleep(0.5)
